...
.text
    ...
    loop:
        ...
        ;									   |
        mul.d f7, f1, f2 ;               F D s m m m m M W 5
		;											   |
        l.d f3, v3(r2) ;                   F D E M W +0
        l.d f4, v4(r2) ;                     F D E M W +0
		;											 | |
        add.d f5, f7, f3 ;                     F D s s a a a a a a M W +6
        ;											 |             |
        mul.d f8, f3, f4 ;                       F D m m m m M W +0|
        div.d f6, f8, f5 ;                         F D s s s s s s d d d d d d d d d d d d d d d d d d d d d d d d M W +24
		
		daddi r1, r1, -1 ;                           F D E M W +0
		
        s.d f5, v5(r2) ;                               F D E M W +0
        s.d f6, v6(r2);                                  F D s s s s s s s s s s s s s s s s s s s s s s s s s s s E M W+1
        
        daddi r2, r2, 8 ;                                  F D s s s s s s s s s s s s s s s s s s s s s s s s s s s E M W +1
...
; main: 5+1 = 6
; loop: 1+1+5 +0+0+6+0 +24+0+0+1+1 +1+1 = 41
; totale: 6 +41*30 = 1236 clock cycle

; calcolato da winMips: 1236 clock cycle