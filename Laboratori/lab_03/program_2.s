...
.text
    ...
    loop:
		...
		;											 |		   |
        add.d f5, f7, f3 ;                     F D s s s s s s a a a a M W +4
        ;											 |				   |
        mul.d f8, f3, f4 ;                       F D m m m m m m m m M W +0
        div.d f6, f8, f5 ;                         F D s s s s s s s s d d d d d d d d d d d d M W +12
		;															   |                     |
		daddi r1, r1, -1 ;                           F D E M W +0      |                     |
		;															   |                     |
        s.d f5, v5(r2) ;                               F D s s s s s s E M W +0              |
        s.d f6, v6(r2);                                  F D s s s s s s s s s s s s s s s s s E M W +1
        
        daddi r2, r2, 8 ;                                  F D s s s s s s s s s s s s s s s s s E M W +1
...
; main: 5+1 = 6
; loop: 1+1+9 +0+0+4+0+12 +0+0+1+1 +1+1 = 31
; totale: 6 +31*30 +0 = 936 clock cycle

; calcolato da winMips: 936 clock cycle
...
; 0 WAW stalls
; 0 WAR stalls
; 90 structural stalls
; 29 branch taken stalls
